      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">2016 &bull; Science fiction film/Action fiction &bull; 3h 3m</span>
          </div>
        </v-card-title>
        <v-card-text>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">2017 &bull; Drama/Science fiction film &bull; 2h 21m</span>
          </div>
        </v-card-title>
        <v-card-text>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">2017 &bull; Fantasy/Science fiction film &bull; 2h 35m</span>
          </div>
        </v-card-title>
        <v-card-text>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">2017 &bull; Fantasy/Science fiction film &bull; 2h 21m</span>
          </div>
        </v-card-title>
        <v-card-text>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">2017 &bull; Drama/Thriller &bull; 2hours</span>
          </div>
        </v-card-title>
        <v-card-text>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">2015 &bull; Drama/Thriller &bull; 2h 36m</span>
          </div>
        </v-card-title>
        <v-card-text>
